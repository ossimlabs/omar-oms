...
*   **transparent**
   ...
   @ApiImplicitParams([
          ...
          @ApiImplicitParam(name = 'brightness', value = 'Brightness Operation',defaultValue="", paramType = 'query', dataType = 'double', required=false),
          @ApiImplicitParam(name = 'contrast', value = 'Contrast Operation',defaultValue="",  paramType = 'query', dataType = 'double', required=false),
          ...
          @ApiImplicitParam(name = 'rrds', value = 'Reduced resolution', defaultValue = '0', readOnly = true,  paramType = 'query', dataType = 'integer', required=false),
...
*   **transparent**
   ...
   @ApiImplicitParams([
          ...
          @ApiImplicitParam(name = 'nullPixelFlip', value = 'Flip interior null pixels to valid', allowableValues="true,false", defaultValue="", paramType = 'query', dataType = 'boolean', required=false),
          @ApiImplicitParam(name = 'brightness', value = 'Brightness Operation',defaultValue="0.0", paramType = 'query', dataType = 'double', required=true),
          @ApiImplicitParam(name = 'contrast', value = 'Contrast Operation',defaultValue="1.0",  paramType = 'query', dataType = 'double', required=true),
          @ApiImplicitParam(name = 'sharpenMode', value = '', defaultValue = '', allowableValues="light,heavy",paramType = 'query', dataType = 'string', required=false),
          @ApiImplicitParam(name = 'thumbnailResolution', value = '', defaultValue = '',  paramType = 'query', dataType = 'integer', required=false),
