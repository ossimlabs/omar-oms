...
*   **transparent**
   ...
   @ApiImplicitParams([
          ...
          @ApiImplicitParam(name = 'brightness', value = 'Brightness Operation',defaultValue="", paramType = 'query', dataType = 'number', required=false),
          @ApiImplicitParam(name = 'contrast', value = 'Contrast Operation',defaultValue="",  paramType = 'query', dataType = 'number', required=false),
