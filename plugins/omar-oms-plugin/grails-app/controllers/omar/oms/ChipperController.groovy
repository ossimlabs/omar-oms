...
*   **gamma**
   ...
   @ApiImplicitParams([
          ...
          @ApiImplicitParam(name = 'operation', value = '', defaultValue = 'chip', allowableValues= "chip", paramType = 'query', dataType = 'string', required=true),
          ...
          @ApiImplicitParam(name = 'cutBboxXywh', value = 'Cut image box separated by commas: **x**,**y**,**width**,**height**', defaultValue = '500,500,500,500',  paramType = 'query', dataType = 'string', required=false),
...
*   **gamma**
   ...
   @ApiImplicitParams([
          ...
          @ApiImplicitParam(name = 'images[0].hist', value = 'Location of histogram', defaultValue = '', paramType = 'query', dataType = 'string', required=false),
          @ApiImplicitParam(name = 'images[0].geom', value = 'Location of geometry', defaultValue = '', paramType = 'query', dataType = 'string', required=false),
          @ApiImplicitParam(name = 'operation', value = '', defaultValue = 'ortho', allowableValues= "ortho", paramType = 'query', dataType = 'string', required=true),
          @ApiImplicitParam(name = 'nullPixelFlip', value = 'Flip interior null pixels to valid', allowableValues="true,false", defaultValue="", paramType = 'query', dataType = 'boolean', required=false),
